"""Tests for ParquetBackend — save / load round-trips across all LoadModes."""
...
class TestQuantParams:
    ...
    def test_quant_params_absent_when_none(self, backend, store_path):
        ...
        # Overwrite without quant_params
